...
const SERVERURL = 'http://192.168.33.10/';
...
//var_dump(1);
$pic = new ImageUploadTool('file','img/');
$pic->acceptSingleFile();
$uploadFiles = $pic->getUploadFiles();
$arr = array(
    'code'=>0,
    'msg'=>'success',
    'data'=>array(
        'src'=>SERVERURL .'robotCommon/'.$uploadFiles[0]
    )
);
